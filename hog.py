...
def free_bacon(score):
    ...
    return (first_digit * second_digit % 10 + 1)
    # END PROBLEM 2
...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    def commentary(score0, score1):
        ...
        new_gain = score - previous_score
        if new_gain > previous_high:
            print (str(new_gain) + ' point(s)!',
                   "That's the biggest gain yet for Player " + str(who))
            x = new_gain
            return announce_highest(who, x, score)
...
def run_experiments():
    ...
    if True:  # Change to False when done finding max_scoring_num_rolls
        ...
        print ('Max scoring num rolls for six-sided dice:',
               six_sided_max)
    if True:  # Change to True to test always_roll(8)
        print ('always_roll(8) win rate:',
               average_win_rate(always_roll(8)))
    if True:  # Change to True to test bacon_strategy
        print ('bacon_strategy win rate:',
               average_win_rate(bacon_strategy))
    if True:  # Change to True to test swap_strategy
        print ('swap_strategy win rate:',
...
def bacon_strategy(
    ...
    # BEGIN PROBLEM 10
    bacon_result = opponent_score // 10 * (opponent_score % 10) % 10 + 1
    if bacon_result >= margin:
        return 0
    else:
        return num_rolls
    # END PROBLEM 10
...
def swap_strategy(
    ...
    # BEGIN PROBLEM 11
    bacon_result = oppo0nent_score // 10 * (oppo0nent_score % 10) % 10 \
        + 1
    if (score + bacon_result) % 10 == oppo0nent_score // 10 \
        or bacon_result >= margin:
        return 0
